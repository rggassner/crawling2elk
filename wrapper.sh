#!/bin/bash
# First instance runs a https server, does the housekeeping and then crawl
# Second instance runs a fast crawler using requests
# Third instance runs a ip/port scanner
# From fourth instance on regular crawlers
mkdir -p pdfs
mkdir -p midis
mkdir -p audios
mkdir -p images/nsfw
